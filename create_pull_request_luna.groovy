...
def owner = "jbosstools"
def repo = "jbosstools-integration-stack-tests"
...
def message = [ issue: issue.toString(), head: username.toString() + ":JBTISTEST-" + issue.toString(), base: "jbtis-4.2.x" ] 
